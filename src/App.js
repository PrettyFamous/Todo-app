    ...
    <div className="todo">
      ...
      <div className="todo__tasks">
          {lists && (activeItem 
                    ...
                    : lists.map(list => 
                        <Tasks key={list.id} list={list} onAddTask={onAddTask} onEditTitle={onEditListTitle} onEditTask={onEditTask} onRemoveTask={onRemoveTask} withoutEmpty/>)
          )}
      </div>
    </div>
  );
